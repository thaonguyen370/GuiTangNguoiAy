...
public class listAdapterBanBeCoTheBiet extends BaseAdapter {
    private banBeActivity context;
    private int layout;
    private ArrayList<userOnline> al;

    public listAdapterBanBeCoTheBiet(banBeActivity context, int layout, ArrayList<userOnline> al) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        v.suKien.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.dialogNhungNguoiCoTheBiet( user1 );
            }
        } );
